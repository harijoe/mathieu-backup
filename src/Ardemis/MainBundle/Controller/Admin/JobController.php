...
class JobController extends Controller
{
     ...
     * @Method("POST")
     * @Template("ArdemisMainBundle:Admin\Job:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $nextAction = $form->get('saveAndAdd')->isClicked()
                ? $this->generateUrl('offres_new')
                : $this->generateUrl('offres_show', array('id' => $entity->getId()));
     ...
     * @Method("PUT")
     * @Template("ArdemisMainBundle:Admin/Job:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            $nextAction = $editForm->get('saveAndAdd')->isClicked()
                ? $this->generateUrl('offres_new')
                : $this->generateUrl('offres_show', array('id' => $id));
            return $this->redirect($nextAction);
        }
