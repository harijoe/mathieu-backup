...
class VersionInit extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE job (id INT AUTO_INCREMENT NOT NULL, createdAt DATETIME NOT NULL, publishedAt DATETIME NOT NULL, published TINYINT(1) NOT NULL, startAt DATETIME NOT NULL, expireAt DATETIME NOT NULL, title VARCHAR(255) NOT NULL, job VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, income VARCHAR(255) NOT NULL, technologies VARCHAR(255) NOT NULL, grade VARCHAR(255) NOT NULL, position INT NOT NULL, location VARCHAR(255) NOT NULL, summary LONGTEXT NOT NULL, description LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
    }
