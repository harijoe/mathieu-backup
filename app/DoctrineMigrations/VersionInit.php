...
class VersionInit extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE candidate (id INT AUTO_INCREMENT NOT NULL, disponibility VARCHAR(255) NOT NULL, disponibility_negociable TINYINT(1) NOT NULL, experience VARCHAR(255) NOT NULL, mobility VARCHAR(255) NOT NULL, mobility_complement VARCHAR(255) NOT NULL, grade VARCHAR(255) NOT NULL, grade_complement VARCHAR(255) DEFAULT NULL, job VARCHAR(255) NOT NULL, income VARCHAR(255) NOT NULL, handicap TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
